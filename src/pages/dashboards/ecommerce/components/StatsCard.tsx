...
import { BadgePercent, Box, ShoppingCart, UsersRound } from 'lucide-react';
        ...
        <>
            {
                statsData.map((item, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`card-body p-6 h-full flex flex-col border-b sm:border-e border-neutral-200 dark:border-slate-600 
