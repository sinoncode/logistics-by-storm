...
} from "@/store/customerDetailsStore";
  ...
  return (
    <>
      ...
      <div className="p-6 pt-5 space-y-6 relative z-0">
        ...
        {/* TOP PROFILE SECTION */}
        <Card className="overflow-hidden bg-gradient-to-r from-[#02374C] via-[#03506F] to-[#046C94] p-10 relative rounded-[32px] shadow-[0px_50px_100px_-20px_rgba(50,50,93,0.25),0px_30px_60px_-30px_rgba(0,0,0,0.3)] mb-15">
          ...
          <div className="relative z-10 flex flex-col xl:flex-row gap-10 items-start xl:items-center">
            ...
            <div className="relative">
              ...
              <img
                src={`https://ui-avatars.com/api/?name=${customer.name}&background=0D8ABC&color=fff&size=200`}
                alt={customer.name}
